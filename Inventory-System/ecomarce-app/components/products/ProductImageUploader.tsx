      ...
      <div className="flex items-center gap-4">
        ...
        <div className="w-16 h-16 rounded-xl bg-slate-800/40 border border-slate-700/50 flex items-center justify-center overflow-hidden shrink-0 relative group">
          {previewUrl ? (
            ...
            <svg className="w-6 h-6 text-slate-650" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex-1">
          ...
          <button
            ...
            className="px-3.5 py-2 bg-slate-800/80 hover:bg-slate-700/80 border border-slate-700/50 rounded-xl text-xs font-semibold text-slate-350 hover:text-white transition-all active:scale-95 flex items-center gap-1.5"
          >
            <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
